    ...
    <script>
        ...
        */
        function onSamples(samples) {
            ...
            spxcodec.bits_size = 70;


            var s1 = new Int16Array(samples.buffer);
            
            var encodingStartedAt = new Date().getTime();

            var spxdata = spxcodec.encode(s1, true);

            console.log('Encoding (ms): ' + (new Date().getTime() - encodingStartedAt));

            var isNarrowband = false;
            ...
            var spxcmt = "Encoded with speex.js";
            ...
            var r = oggdata.mux([spxhdr.raw, spxcmt.raw, spxdata]);
            console.log('Muxing (ms): ' + (new Date().getTime() - muxingStartedAt));

            addDownloadLink("zzz.ogg", "#file_wav", r, "audio/ogg");
    ...
    */
        ...
        function timerStart() {
            ...
            timerId = window.setInterval(function () {
                $("#time").text(new Date().getTime() - time);
            }, 100);
        }
        function timerStop() {
